...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp0(PureMVC.Patterns.INotification p0)
		{
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(PureMVC.Patterns.HandleNotification))
			{
			    return new PureMVC.Patterns.HandleNotification(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(Game.LuaAwake))
			{
			    return new Game.LuaAwake(__Gen_Delegate_Imp1);
			}
