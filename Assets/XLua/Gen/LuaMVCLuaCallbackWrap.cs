...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaMVCLuaCallbackWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaMVC.LuaCallback);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LuaMVC.LuaCallback __cl_gen_ret = new LuaMVC.LuaCallback();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaMVC.LuaCallback constructor!");
        ...
        static int _g_get_luaCallback(RealStatePtr L)
        {
		    try {
                ...
                LuaMVC.LuaCallback __cl_gen_to_be_invoked = (LuaMVC.LuaCallback)translator.FastGetCSObj(L, 1);
